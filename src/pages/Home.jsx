      ...
      <div className="relative max-w-6xl mx-auto grid gap-12 md:grid-cols-12 items-center z-10 w-full">
        <div className="md:col-span-7 space-y-6 text-center md:text-left">
          <motion.div
            ...
            className="inline-block px-4 py-1.5 rounded-full glass-panel text-xs text-purple-400 font-bold tracking-wide"
          >
          ...
          <div className="space-y-4">
            <h2 className="text-lg sm:text-xl font-medium text-purple-300 leading-relaxed max-w-xl">
            ...
            <div className="max-w-2xl rounded-2xl border border-white/10 bg-white/5 overflow-hidden">
              <div className="px-4 py-2 text-[10px] uppercase tracking-[0.35em] text-gray-500 border-b border-white/5">
                What I deliver
              </div>
              <div className="overflow-hidden">
                <div className="flex w-max items-center gap-3 px-4 py-3 animate-marquee text-sm sm:text-base font-semibold text-gray-200">
          ...
          <div className="flex flex-wrap justify-center md:justify-start gap-4 pt-4">
            ...
            <Link
              ...
              className="px-6 py-3 bg-white/5 hover:bg-white/10 text-white text-sm font-bold rounded-xl border border-white/15 hover:border-white/20 transition duration-300 transform hover:-translate-y-0.5"
            >
              Hire Me
            </Link>
            ...
            <a
              href="/resume.pdf"
              download
              className="px-6 py-3 bg-white/5 hover:bg-white/10 text-gray-300 hover:text-white text-sm font-bold rounded-xl border border-white/15 hover:border-white/20 transition duration-300 transform hover:-translate-y-0.5"
            >
              Download CV
            </a>
            ...
            <Link
              to="/contact"
              className="px-6 py-3 bg-purple-600/10 hover:bg-purple-600/20 text-purple-400 hover:text-purple-300 text-sm font-bold rounded-xl border border-purple-500/20 hover:border-purple-500/30 transition duration-300 transform hover:-translate-y-0.5"
            >
              Contact Me
            </Link>
            ...
            <a
              ...
              className="px-6 py-3 bg-emerald-500/10 hover:bg-emerald-500/20 text-emerald-300 hover:text-emerald-200 text-sm font-bold rounded-xl border border-emerald-500/20 hover:border-emerald-500/30 transition duration-300 transform hover:-translate-y-0.5 inline-flex items-center gap-2"
            >
        ...
        <div className="md:col-span-5 flex justify-center items-center">
          <motion.div
            className="relative p-3 rounded-3xl glass-panel relative overflow-hidden group shadow-2xl w-full max-w-sm"
          ...
          >
            ...
            <img
              src="/avatar.png"
              alt="Umar Portrait"
              className="w-full h-80 object-cover rounded-2xl bg-slate-900 border border-white/5"
            />
          </motion.div>
        </div>
      </div>
